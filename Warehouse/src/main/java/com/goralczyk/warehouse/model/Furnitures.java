...
public class Furnitures {
	...
	private TypeOfBox typeOfBox = TypeOfBox.Furnitures;
	
	public Furnitures(){
		
	}
	
	public Furnitures(String description, Date date, int numberOfSwitching, int numberOfBox, int priority,
			TypeOfBox typeOfBox) {
		super();
	...
	public String toString() {
		return "Furnitures [description=" + description + ", date=" + date + ", numberOfSwitching=" + numberOfSwitching
